...
<head>
  ...
  <title>Home | Threeds</title>
  <link rel="shortcut icon" type="image/png" href="assets/images/threeds.png">
      ...
      <div class="sidebar-left">
        <div class="grid-sidebar" style="margin-top: 12px">
          <div class="icon-sidebar-align">
            <img src="assets/images/threeds.png" alt="" height="30px" width="30px" />
          </div>
        </div>
        ...
        <a href="home.php">
          <div class="grid-sidebar bg-active" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src="assets/images/threeds.png" alt="" height="26.25px" width="26.25px" />
            </div>
        ...
        <a href="notification.php">
          <div class="grid-sidebar">
            <div class="icon-sidebar-align position-relative">
              ...
              <?php } ?>
              <img
                src="/includes/icons/tweetnotif.png"
                alt=""
                height="26.25px"
                width="26.25px" />
            </div>
                    ...
                    <form class="" action="handle/handleTweet.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="bottom">
                        ...
                        <div>
                          ...
                          <input id="tweet-input" type="submit" name="tweet" value="Thred" class="submit">
                        </div>
                      </div>
                    </form>
                  </div>
