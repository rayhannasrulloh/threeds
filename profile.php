...
<head>
    ...
    <title> <?php echo $profileData->name; ?> (@<?php echo $profileData->username; ?>) | Threeds</title>
        ...
        <div class="sidebar-left">
          <div class="grid-sidebar" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src="<?php echo BASE_URL . "/assets/images/threeds.png"; ?>" alt="" height="30px" width="30px" />
            </div>
          </div>
                 ...
                 <div   class="row position-fixed box-name">
                       ...
                       <div class="col-xs-10">
                           ...
                           <p class="home-tweets-num">
                              <?php echo Tweet::countTweets($profileData->id); ?> Threeds</p>
                      </div>
                 </div>
